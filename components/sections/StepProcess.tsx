          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-5 relative z-10">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center text-center group">
                <div className="h-16 w-16 rounded-full bg-white border-2 border-[#c5a059] flex items-center justify-center text-2xl font-serif text-[#c5a059] mb-8 shadow-sm transition-transform group-hover:scale-110">
                  {index + 1}
                </div>
